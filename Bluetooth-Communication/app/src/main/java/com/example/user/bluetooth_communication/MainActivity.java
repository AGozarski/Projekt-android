...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    // TODO: Czemu nie mozna usunac startBTConnection() ???
...
//***remember the conncction will fail and app will crash if you haven't paired first
    public void startConnection(){
        try {
            ...
            intent.putExtra("mBluetoothDevice", mBTDevice);
            //intent.putExtra("mBTConnectionService", );
            startActivity(intent);
        }catch ( NullPointerException e){
        Log.i(TAG, "No device to connection");
    ...
    public static BluetoothConnectionService getmBluetoothConnection() {
